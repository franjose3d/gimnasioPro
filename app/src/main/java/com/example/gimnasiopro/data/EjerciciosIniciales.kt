    ...
    fun getEjerciciosIniciales(): List<Ejercicio> {
        return listOf(
            ...
            Ejercicio(
                id = 30,
                grupoMuscular = "Espalda",
                grupoMuscularSecundario = "Pectorales",
            ...
            Ejercicio(
                ...
                descripcion = "Ejercicio aeróbico sobre cinta motorizada a ritmo variable. Mejora la resistencia 			cardiovascular, quema calorías y fortalece la musculatura de piernas y glúteos. Permite ajustar velocidad e 		inclinación.",
                imagenUrl = null
            ),
            Ejercicio(
                id = 162,
                ...
                descripcion = "Pedaleo de bajo impacto articular sobre bicicleta fija. Trabaja cuádriceps, isquiotibiales y 		gemelos mientras mejora la capacidad aeróbica. Ideal para recuperación activa o cardio de larga duración.",
                imagenUrl = null
            ),
            Ejercicio(
                id = 163,
                ...
                descripcion = "Movimiento combinado de piernas y brazos con impacto casi nulo en articulaciones. Trabaja 		tren inferior y superior simultáneamente. Excelente opción para cardio completo con bajo riesgo de 			lesión.",
                imagenUrl = null
            ),
            Ejercicio(
                id = 164,
                grupoMuscular = "Piernas",
                grupoMuscularSecundario = "Glúteos",
                nombre = "Escalera estática",
                descripcion = "Simulación de subida de escaleras con resistencia ajustable. Alta intensidad cardiovascular 		con fuerte trabajo de glúteos, cuádriceps e isquiotibiales. Una de las máquinas con mayor gasto calórico 		por minuto.",
                imagenUrl = null
            ),
